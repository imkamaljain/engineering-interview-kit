...
A very common variation (LeetCode [#57](https://leetcode.com/problems/insert-interval)) provides a *pre-sorted* list of non-overlapping intervals, and asks you to insert a single new interval into the correct spot, merging if necessary.
