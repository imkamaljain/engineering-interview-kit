...
The absolute best example of this pattern is LeetCode [#238](https://leetcode.com/problems/product-of-array-except-self): *"Given an integer array, return an array `answer` such that `answer[i]` is equal to the product of all the elements of the original array except `nums[i]`. You must write an algorithm that runs in $O(N)$ time and without using the division operation."*
