...
```mermaid
%%{init: {'gantt': {'barHeight': 50, 'barGap': 15, 'fontSize': 16, 'sectionFontSize': 16, 'leftPadding': 130}}}%%
gantt
    title Trace ID: 9f8a3... (Total Time: 6s)
    dateFormat  x
    axisFormat %S.%L
    
    section API Gateway
    Forward Req      :a1, 0, 1000ms
    
    section Auth Service
    Validate Token   :a2, after a1, 1500ms
    
    section Payment Service
    Stripe API Call  :crit, a3, after a2, 2500ms
    
    section Order Service
    Save to DB       :a4, after a3, 1000ms
```
