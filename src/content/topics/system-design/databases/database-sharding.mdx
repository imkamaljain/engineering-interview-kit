...
```mermaid
flowchart TD
    App["App Server"] --> Router{"Shard Router<br/>(Consistent Hashing)"}
    
    subgraph "The Sharded Cluster"
        Router -->|"User ID: 1-1000"| S1[("Shard 1<br/>Server A")]
        Router -->|"User ID: 1001-2000"| S2[("Shard 2<br/>Server B")]
        Router -->|"User ID: 2001-3000"| S3[("Shard 3<br/>Server C")]
    end
    
    Note["Each Shard is a completely independent database.<br/>They share nothing."]
```
