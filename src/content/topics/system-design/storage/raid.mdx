...
```mermaid
flowchart TD
    subgraph S1 ["RAID 0 (Striping)"]
        Data1["Data: A B C D"] --> Disk1A[("Disk 1<br/>A, C")]
        Data1 --> Disk1B[("Disk 2<br/>B, D")]
        Note1["Fast! But if 1 disk dies,<br/>ALL data is lost."]
    end

    subgraph S2 ["RAID 1 (Mirroring)"]
        Data2["Data: A B C D"] --> Disk2A[("Disk 1<br/>A B C D")]
        Data2 --> Disk2B[("Disk 2<br/>A B C D")]
